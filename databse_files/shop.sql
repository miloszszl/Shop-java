...
INSERT INTO `uzytkownicy` (`idUzytkownika`, `imie`, `nazwisko`, `login`, `mail`, `telefon`, `idMiasta`, `nazwaUlicy`, `numerDomu`, `idTypuKonta`, `sol`, `haslo`) VALUES
	(12, NULL, NULL, 'admin', 'as', NULL, NULL, NULL, NULL, 1, NULL, 'password'),
	(14, NULL, NULL, 'user', 'qw', NULL, NULL, NULL, NULL, 2, NULL, 'password');
